...
class ControllerExtensionModuleNewsletter extends Controller
{
    ...
    protected function getForm()
    {
        ...
        $data['cancel'] = $this->url->link('extension/module/newsletter', 'user_token=' . $this->session->data['user_token']. '&type=module', true);
        $data['save']   = $this->url->link('extension/module/newsletter/newssubscribe', 'user_token=' . $this->session->data['user_token'], true);
        $data['action'] = $this->url->link('extension/module/newsletter/newssubscribe', 'user_token=' . $this->session->data['user_token'], true);
    ...
    protected function getList()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/newsletter', 'user_token=' . $this->session->data['user_token'] . $url, true)
        );
        ...
        $data['completemail']      = $this->url->link('extension/module/newsletter/NewsletterComplete', 'user_token=' . $this->session->data['user_token'], true);
        $data['addemail']          = $this->url->link('extension/module/newsletter/NewsletterAdd', 'user_token=' . $this->session->data['user_token'], true);
        $data['newrestore']        = $this->url->link('extension/module/newsletter/NewsletterImport', 'user_token=' . $this->session->data['user_token'], true);
        ...
        foreach ($result as $result) {
            $data['newsltr'][] = array(
                ...
                'delete' => $this->url->link('extension/module/newsletter/NewsletterDelete', 'user_token=' . $this->session->data['user_token'] . '&newsletter_email=' . $result['newsletter_email'], true)
        ...
        $pagination->url   = $this->url->link('extension/module/newsletter', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
    ...
    public function NewsletterImport()
    {
        ...
        $data['cancel']        = $this->url->link('extension/module/newsletter', 'user_token=' . $this->session->data['user_token']. '&type=module', true);
        $data['action']        = $this->url->link('extension/module/newsletter/NewsletterImport', 'user_token=' . $this->session->data['user_token'], true);
        $data['button_save']   = $this->language->get('button_save');
        $data['button_cancel'] = $this->language->get('button_cancel');
